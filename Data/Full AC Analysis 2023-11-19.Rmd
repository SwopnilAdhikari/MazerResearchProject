...
# Ignore this code chunk because there's a problem with the lmer package

```{r}



#Model_1 <- lmer(Log_Stem_Biomass_MC ~ (1|Donor:Recipient), data=AC_MeanCentered_AllTransects)

#Model_2 <- lmer(Log_Lifetime_Fecundity_MC ~ Corolla_Diameter_MC + Log_Stem_Biomass_MC + (1|Donor:Recipient), data = AC_MeanCentered_AllTransects)
